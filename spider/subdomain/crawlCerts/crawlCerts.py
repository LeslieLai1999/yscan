...
class crawlCerts:
    def __init__(self, domain, subdomains):
        ...
        self.cacert_path = getRootPath()+'spider/subdomain/crawlCerts/cacert.pem'
...
if __name__ == '__main__':
    domain = 'zjhu.edu.cn'
    subdomains = ['faceid.zjhu.edu.cn', 'dyb.zjhu.edu.cn', 'cgzx.zjhu.edu.cn', 'dag.zjhu.edu.cn']
